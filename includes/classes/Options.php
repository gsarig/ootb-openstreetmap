...
class Options {
	 ...
	 * @return void
	 */
	public function field_prevent_default_gestures( array $args ): void {
	 ...
	 * @return void
	 */
	public function field_geodata( array $args ): void {
		$option = Helper::get_option( 'all' );
		?>
		<input type="checkbox" name="ootb_options[<?php echo esc_attr( $args['label_for'] ); ?>]"
				id="<?php echo esc_attr( $args['label_for'] ); ?>"
	 ...
	 * @return void
	 */
	public function field_geo_post_types( array $args ): void {
		$option     = Helper::get_option( 'all' );
	 ...
	 * @return void
	 */
	public function section_frontend_callback( array $args ): void {
		?>
	 ...
	 * @return void
	 */
	public function section_custom_fields_callback( array $args ): void {
		?>
		<p id="<?php echo esc_attr( $args['id'] ); ?>">
			<?php
	 ...
	 * @return void
	 */
	public function section_defaults_callback( array $args ): void {
		?>
		<p id="<?php echo esc_attr( $args['id'] ); ?>">
			<?php
			printf(
	 ...
	 * @return void
	 */
	public function section_settings_callback( array $args ): void {
		?>
		<div class="ootb_info">
	 ...
	 * @return void
	 */
	public function field_api_key_mapbox( array $args ): void {
		$option = Helper::get_option( 'all' );
		?>
	 ...
	 * @return void
	 */
	public function field_coordinates( array $args ): void {
		$option   = Helper::get_option( 'all' );
	 ...
	 * @return void
	 */
	public function section_openai_callback( array $args ): void {
		?>
		<p id="<?php echo esc_attr( $args['id'] ); ?>">
			<?php
	 ...
	 * @return void
	 */
	public function field_api_ai_text( array $args ): void {
		$option = Helper::get_option( 'all' );
		?>
		<input type="text" name="ootb_options[<?php echo esc_attr( $args['label_for'] ); ?>]"
				id="<?php echo esc_attr( $args['label_for'] ); ?>"
	 ...
	 * @return void
	 */
	public function field_api_key_openai( array $args ): void {
		$option = Helper::get_option( 'all' );
		?>
		<input type="password" name="ootb_options[<?php echo esc_attr( $args['label_for'] ); ?>]"
				id="<?php echo esc_attr( $args['label_for'] ); ?>"
	 ...
	 * @return void
	 */
	public function enqueues( string $hook ): void {
