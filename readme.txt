...
If you are running WordPress 7.0 or later and a site-level AI connector is configured at Settings → Connectors, you can skip the above. The plugin will use the connector automatically, with no API key required on your part.
...
= 2.8.8 =
* Added filter hook `ootb_block_marker_text` to allow customization of marker popup content
* Build script updates
